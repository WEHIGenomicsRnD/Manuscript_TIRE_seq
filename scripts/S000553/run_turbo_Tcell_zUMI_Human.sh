...
#SBATCH -e logs/zUMI-%j.err
#SBATCH -o logs/zUMI-%j.out
#SBATCH --job-name=zUMI_Tcell
...
bash /vast/projects/G000448_Protein_display/envs/zUMIs/zUMIs.sh -c -y \
    /stornext/Home/data/allstaff/b/brown.d/Projects/G000278_TurboCapSeq/config/zUMI/S000553/S000553_Tcell_zUMI-Hs.yaml;
