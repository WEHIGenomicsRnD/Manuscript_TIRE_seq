---
title: "S000553 T cell human Generate downssampled SCE object"
author: "Daniel Brown"
date: "`r Sys.Date()`"
output:
  html_document:
...
In this notebook I generate the downsampled object.
...
gene_names <- read_tsv(here::here(
  "/vast/projects/G000448_Protein_display/BulkRNA_Manuscript/TIRE/Tcell/expression/TIRE_downsample_Tcell.gene_names.txt"))
...
mapping <- read_tsv(here::here(
  "/vast/projects/G000448_Protein_display/BulkRNA_Manuscript/TIRE/Tcell/stats/TIRE_downsample_Tcell.readspercell.txt"))

zUMI <- here::here("/vast/projects/G000448_Protein_display/BulkRNA_Manuscript/TIRE/Tcell/expression/TIRE_downsample_Tcell.dgecounts.rds")
```
...
At 988k reads per sample * 96 = 94,848,000 reads per library the saturation is 60%

Compare this to nearly 70% saturation for the full sequencing data amount.

```{r}
stat_umi <-  read_tsv(here::here(
  "/vast/projects/G000448_Protein_display/BulkRNA_Manuscript/TIRE/Tcell/stats/TIRE_downsample_Tcell.UMIcounts.txt"))
...
write_csv(tb, here::here(
  "data/TIRE_Tcell/Matrices/Downsample", "tcell_ds_qc.csv"))
```
...
saveRDS(dge, here::here(
  "data/TIRE_Tcell/SCEs", "tire_tcell_ds_basic.dge.rds"))
```
